...
public class softAssertOne {
	
	// Test app is Fitness_Calculator.apk
	// Demonstration for soft Assert, in case of SoftAssert the execution of case continues
	// after the assertion fails.
